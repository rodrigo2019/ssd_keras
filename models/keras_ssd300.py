...
def ssd_300(image_size,
    ...
    Arguments:
        ...
        offsets (list, optional): `None` or a list with as many elements as there are predictor layers. The elements can
            be either floats or tuples of two floats. These numbers represent for each predictor layer how many
            ...
            represent `(vertical_offset, horizontal_offset)`. If no offsets are provided, then they will default to 0.5
            of the step size.
    ...
    if scales:
        ...
        # If no explicit list of scaling factors was passed, compute the list of scaling factors from
    ...
    # We precidt `n_classes` confidence values for each box, hence the confidence predictors have depth
    # `n_boxes * n_classes`
